                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            ...
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 112px;"
                                                                            width="112"
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <strong><span
                                                                            style="font-size: 44px; line-height: 70.4px;">{{
                                                                            $code}}</span></strong>
                                                                </p>
                                                            </div>
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_8" style="font-family:'Cabin',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <h3><span tabindex="-1"
                                                                        style="line-height: 25.2px; font-size: 14px;"
                                                                        role="gridcell" translate="no"><span
                                                                            style="line-height: 25.2px;"
                                                                            data-hovercard-owner-id="56"
                                                                            data-hovercard-id="wbmispsfa2023@gmail.com"
                                                                            name="Parokya ng San Francisco ng Assisi">Parokya
                                                                            ng San Francisco ng Assisi</span></span>
                                                                </h3>
                                                            </div>
