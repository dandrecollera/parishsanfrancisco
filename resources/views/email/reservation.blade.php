                                        ...
                                        <div
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://raw.githubusercontent.com/dandrecollera/parishsanfrancisco/master/public/img/Logo.png"
                                                                            alt="image" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 21%;max-width: 117.6px;"
                                                                            width="117.6"
                                            ...
                                            <table id="u_content_text_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 70px 20px 40px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;"><span
                                                                    ...
                                                                    @if ($subject == "Reservation Update")
                                                                    Thank you for using our website <bold>{{$user}}
                                                                    </bold>
                                                                    @else
                                                                    Good Day <bold>{{$user}}</bold>
                                                                    @endif
                                                                ...
                                                                <p style="line-height: 140%;">
                                                                    {{$subject == "Reservation Update" ? 'Please wait
                                                                    for the confirmation of your reservation:' : ''}}
                                                                    {{$subject == "Reservation Approved" ? 'Your
                                                                    reservation has been approved:' : ''}}
                                                                    {{$subject == "Reservation Completed" ? 'Your
                                                                    reservation has been completed:' : ''}}
                                                                    {{$subject == "Reservation Rescheduled" ? 'Your
                                                                    reservation has been rescheduled:' : ''}}
                                                                    {{$subject == "Reservation Cancelled" ? 'Your
                                                                    reservation has been cancelled:' : ''}}
                                                                    <br><br>
                                                                </p>
                                                                <p style="line-height: 140%;">Reservation ID:
                                                                    {{$info->id}}</p>
                                                                <p style="line-height: 140%;">Event Type:
                                                                    {{$info->event_type}} {{$info->service}}</p>
                                                                <p style="line-height: 140%;">Event Date: {{
                                                                    \Carbon\Carbon::create($info->year, $info->month,
                                                                    $info->day)->format('F d Y') }}</p>
                                                                <p style="line-height: 140%;">Start Time: {{
                                                                    \Carbon\Carbon::parse($info->start_time)->format('h:i
                                                                    A')
                                                                    }}</p>
                                                                <p style="line-height: 140%;">End Time: {{
                                                                    \Carbon\Carbon::parse($info->end_time)->format('h:i
                                                                    A')
                                                                    }}</p>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <div>
                                                                    <div>Parokya ng San Francisco ng Assisi</div>
                                                                </div>
                                                            </div>
