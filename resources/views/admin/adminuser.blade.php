...
<div class="container-fluid">
    ...
    <div class="btn-group">
        <button type="button" id="addbutton" class="btn btn-dark shadow-sm btn-sm" data-mdb-toggle="modal"
            data-mdb-target="#addeditmodal"><i class="fa-solid fa-circle-plus"></i> Add A New User</button>
    </div>
        ...
        <div class="col">
            <form method="get">
                ...
                <div class="input-group mb-3">
                    ...
                    @if(!empty($keyword))
                    <button class="btn btn-dark" type="button" onclick="location.href='./adminuser'"><i
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">
                            <span
                                class="{{ $orderbylist[$sort]['display'] == 'Username' ? 'text-primary' : '' }}"><strong>Username</strong></span>
                        </th>
                        <th scope="col">
                            <span
                        ...
                        <th scope="col">
                            <span
                                class="{{ $orderbylist[$sort]['display'] == 'Account Type' ? 'text-primary' : '' }}"><strong>Account
                                    Type</strong></span>
                        </th>
                        <th scope="col">
                            <span
                ...
                <tbody>
                    ...
                    <tr class="{{$dbr->status == 'inactive' ? 'table-danger' : ''}}">
                        ...
                        <td>{{$dbr->lastname}}</td>
                        <td style="text-transform: capitalize;">{{$dbr->accounttype}}</td>
                        <td style="text-transform: capitalize;">{{$dbr->status}}</td>
                        <td>

                            @if ($dbr->id != 1 && $dbr->id != $userinfo[0])
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.azu-edit').on('click', function(){
            ...
            $('#addeditmodalLabel').html('Edit User Account');
            $('#addeditframe').attr('src', '/adminuser_edit?id='+sid);
        })
