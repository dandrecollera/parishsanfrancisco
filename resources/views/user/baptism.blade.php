...
@section('content')
<form method="POST" action="/baptism_add_process" target="_parent" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-outline mb-3">
        <input ype="number" class="form-control" name="godfather" required>
        <label class=" form-label" for="godfather">No. of Godfather*</label>
    </div>

    <div class="form-outline mb-3">
        <input ype="number" class="form-control" name="godmother" required>
