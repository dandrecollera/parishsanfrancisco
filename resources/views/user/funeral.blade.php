...
@section('content')
<form method="POST" action="/funeral_add_process" target="_parent" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-outline mb-3">
        <input type="text" class="form-control" name="deceasedname" id="deceasedname" required>
    ...
    <div class="form-outline mb-3">
        <input type="date" id="passingdate" name="passingdate" class="form-control" required>
