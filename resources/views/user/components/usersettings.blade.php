...
@section('content')
<main style="min-height: 120vh" class="mt-3 pt-3">
    <div class="container-xl">
        ...
        @endif
        <h1>User Settings</h1>
        <form method="POST" action="/usersettings_edit_process" target="_parent">
            @csrf

            <h4>Personal Information</h4>
            <div class="form-outline mb-3">
                <input type="email" class="form-control" name="email" id="email" value="{{$selecteduser->email}}"
                    required>
            ...
            <div class="form-outline mb-3">
                <input type="date" id="birthdate" name="birthdate" class="form-control"
                    value="{{$selecteduser->birthdate}}" required>
        ...
        <br><br>
        <hr>
        <form action="/usersettings_pass_process" method="POST" target="_parent">
            @csrf
